---
layout: post
title:  "Deep Learning-word2vec 词向量"
date:   2016-10-23 10:43:16 +0800
categories: Deep Learning
#header-img: "img/post-bg-js-module.jpg"
tags:
    - DeepLearning word2vec 词向量
---
...
![](../img/article/2016-10-23-nnlm.png)
...
![](../img/article/2016-10-23-cbow.png)

由图可以看出来，这里的输入是直接求和到隐藏层。要求的是$$P(w_t|w_{t-k},w_{t-k+1},...w_{t+k},)$$
...
关于这个思想的提出，我们想下之前的NNLM中的输出有|V|个节点，对于每个节点都要计算其是不是的概率值，那么计算量还是比较大的。
...
![](../img/article/2016-10-23-skip-gram.png)
...
5.[Deep Learning实战之word2vec](http://techblog.youdao.com/?p=915)